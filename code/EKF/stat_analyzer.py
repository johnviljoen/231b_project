...
for run in range(runs):
    for experimentalRun in tqdm(range(100)):
        ...
        internalState[4] = Sigma_vv
        internalState[5] = Sigma_ww
        internalState[6] = cumulative_vv
        internalState[7] = cumulative_ww
        internalState[8] = count_vv
        internalState[9] = count_ww
        ...
        cumulative_vv = internalState[6]
        cumulative_ww = internalState[7] 
        count_vv = internalState[8]
        count_ww = internalState[9]
